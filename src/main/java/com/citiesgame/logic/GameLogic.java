...
public class GameLogic {
    ...
    public static void startGame() {
        ...
        System.out.println("Let's start from the city: " + START_CITY + System.lineSeparator() + "Your turn!");
        ...
        while (true) {
            ...
            try {
                ...
                if (isSuitableCity(START_CITY, inputCity)) {
                    ...
                    throw new IncorrectCityException("The city " + inputCity + " that you entered is incorrect answer!"
    ...
    private static boolean isSuitableCity(String previousCity, String currentCity) {

        return currentCity.regionMatches(true, 0, previousCity, previousCity.length() - 1, 1)
    ...
    private static void systemAnswerCity(String inputCity) {
        for (String city : CITIES) {
            if (isSuitableCity(inputCity, city)) {
                System.out.println("And my answer is... " + System.lineSeparator() + city + ". Thank you for playing!");
                return;
            }
        }
        System.out.println("Sorry, I don't have any suitable city in my memory for the answer. You a winner!");
    }
}
